/* GGFC 3.18.1: One password field; server-side Firebase password verification. */
const GGFC = (() => {
  ...
  function split(data,revision,uid,timestamp){
    ...
    encoded.meta={version:'3.18.1',revision,updatedBy:uid,savedAt:timestamp,keyEncoding:'base64url-v1'};
    return encoded;
  }
